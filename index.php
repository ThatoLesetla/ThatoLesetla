					...
					<h1>Thato Lesetla</h1>
						<h2>I'm a 
								<span
									class="txt-rotate"
									data-period="2000"
									data-rotate='[ "Software Developer.", "Cloud Engineer.", "Techie.", "Graphic Designer.", "Blogger" ]'></span>
							</h2>
						</div>
		</div>
		</div>
		...
		<div class="row d-flex no-gutters">
			<div class="col-md-6 col-lg-6 d-flex">
				<div class="img-about img d-flex align-items-stretch">
					<div class="overlay"></div>
					<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(<?php echo get_theme_file_uri('/images/about.jpeg') ?>);">
					</div>
				</div>
			</div>
			<div class="col-md-6 col-lg-6 pl-md-5 py-5">
				...
				<ul class="about-info mt-4 px-md-0 px-2">
					...
					<li class="d-flex"><span>Address:</span> <span>Johannesburg, South Africa</span></li>
					<li class="d-flex"><span>Email:</span> <span>tlesetla6198@gmail.com</span></li>
					<li class="d-flex"><span>Phone: </span> <span>+27 68 407 0734</span></li>
				</ul>
				</div>
			</div>
				...
				<div class="col-md-9">
					...
					<div class="resume-wrap d-flex ftco-animate">
						...
						<div class="text pl-3">
							...
							<span class="position">National Diploma: Software Development</span>
					...
					<div class="resume-wrap d-flex ftco-animate">
						...
						<div class="text pl-3">
							...
							<h2>Springs Boys High School</h2>
							<span class="position">Mathematics | English | Afrikaans | Business Studies | Accounting | Life Sciences</span>
							<p>A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>
						</div>
					</div>
					</div>
					...
					<div class="resume-wrap d-flex ftco-animate">
						...
						<div class="text pl-3">
							...
							<h2>ABSA Group Limited</h2>
							<span class="position">Specialist Product Engineer</span>
							<p>Contributin .</p>
						</div>
					</div>
					<div class="resume-wrap d-flex ftco-animate">
						...
						<div class="text pl-3">
							...
							<p>Designing and implementing software solutions for ABSA. Responsible for developing RESTFUL API's, reports through data analysis, testing applications and containerising applications for deployments</p>
						</div>
					</div>
					</div>
...
<section class="ftco-section ftco-project" id="projects-section">
	<div class="container-fluid px-md-0">
		...
		<div class="row no-gutters">
			<div class="col-md-4">
				<div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_file_uri('/images/work-1.jpg') ?>);">
					<div class="overlay"></div>
			...
			<div class="col-md-4">
				<div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_file_uri('/images/work-2.jpg') ?>);">
					<div class="overlay"></div>
					<div class="text text-center p-4">
						<h3><a href="#">Branding &amp; Illustration Design</a></h3>
						<span>Web Design</span>
			...
			<div class="col-md-4">
				<div class="project img ftco-animate d-flex justify-content-center align-items-center" style="background-image: url(<?php echo get_theme_file_uri('/images/work-3.jpg') ?>);">
					<div class="overlay"></div>
					<div class="text text-center p-4">
						<h3><a href="#">Branding &amp; Illustration Design</a></h3>
						<span>Web Design</span>
...
<section class="ftco-section" id="blog-section">
	...
	<div class="row d-flex">
		...
		<div class="blog-entry justify-content-end">
			<a href="single.html" class="block-20" style="background-image: url(<?php echo get_theme_file_uri('/images/image_1.jpg') ?>);">
			</a>
		...
		<div class="col-md-4 d-flex ftco-animate">
		<div class="blog-entry justify-content-end">
			<a href="single.html" class="block-20" style="background-image: url(<?php echo get_theme_file_uri('/images/image_2.jpg') ?>);">
			</a>
			<div class="text mt-3 float-right d-block">
			<h3 class="heading"><a href="single.html">Why Lead Generation is Key for Business Growth</a></h3>
			<div class="d-flex align-items-center mb-3 meta">
		...
		<div class="blog-entry">
			<a href="single.html" class="block-20" style="background-image: url(<?php echo get_theme_file_uri('/images/image_3.jpg') ?>);">
			</a>
			<div class="text mt-3 float-right d-block">
			<h3 class="heading"><a href="single.html">Why Lead Generation is Key for Business Growth</a></h3>
			<div class="d-flex align-items-center mb-3 meta">
...
<section class="ftco-section ftco-hireme img" style="background-image: url(<?php echo get_theme_file_uri('/images/bg_1.jpg') ?>)">
	<div class="overlay"></div>
		<div class="container">
...
<section class="ftco-section contact-section ftco-no-pb" id="contact-section">
	...
	<div class="row no-gutters block-9">
		...
		<div class="img" style="background-image: url(<?php echo get_theme_file_uri('/images/about.jpg') ?>);"></div>
		</div>
	</div>
	</div>
</section>
